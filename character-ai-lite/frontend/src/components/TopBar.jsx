...
export default function TopBar({ toggleSidebar, title, subtitle }) {
  return (
    <header className="flex items-center p-4 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm z-10 sticky top-0">
